...
export function VendorHeader({
  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 sm:h-16 w-full items-center justify-between border-b border-border bg-background/95 px-2.5 sm:px-6 backdrop-blur-md">
      ...
      <div className="flex min-w-0 items-center gap-1.5 pr-1 sm:pr-2">
        ...
        <h1 className="min-w-0 max-w-[80px] min-[360px]:max-w-[105px] min-[400px]:max-w-[135px] sm:max-w-none truncate font-display text-caption sm:text-body font-extrabold tracking-tight text-foreground">
          {store.name || "My Store"}
        </h1>
        <button
          type="button"
      ...
      <div className="flex shrink-0 items-center gap-1 sm:gap-2.5">
        ...
        <button
          ...
          className="relative flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl text-muted transition-colors hover:bg-surface-elevated hover:text-foreground active:scale-95"
        >
          <span
